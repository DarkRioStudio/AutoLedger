...
| v1.5.0 | 1.4.0 | Planned | iPad workspace, batch import, batch OCR / receipt cleanup, multi-ledger support, better statistics and data cleaning, improved Apple Watch workflow, iPad screenshot pipeline |
