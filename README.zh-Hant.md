...
- `v1.6.4` 進入規劃階段，聚焦 Personal Pro 訂閱基礎、Free / Pro 邊界、郵箱自動化 gate 和 StoreKit / App Review 準備。
...
| v1.6.4 | 1.5.0 預設沿用 | 規劃中 | Personal Pro 訂閱基礎：`ProEntitlementManager`、`ProFeature` gate、Pro 頁面、恢復購買、郵箱自動化 gate、授權引導和到期不鎖歷史資料 |
