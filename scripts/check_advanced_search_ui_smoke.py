...
def main() -> int:
    ...
    require(ledger, "await store.loadLedgerListTransactions", "LedgerView background search", failures)
    require(ledger, "request == searchRequest", "LedgerView stale result protection", failures)
