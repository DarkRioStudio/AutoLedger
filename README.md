...
| 🎙️ | **语音记账** | Siri / App 内麦克风听写或输入一句话记录支出，高置信直接保存，不明确时进入确认 |
...
**语音记账** — 在账本页点击波形按钮，可直接点麦克风听写，或输入「午饭 28 元」后确认保存；也可通过 Siri/快捷指令触发语音记账
...
| v1.3.1 | ✅ 代码完成 | 语音记账 MVP、Siri/AppIntent 入口、App 内确认页、语音来源与调试记录、语音解析回归 |
