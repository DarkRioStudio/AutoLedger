...
<p align="center">
  <strong>本地优先的个人自动化账本与酒店水单归档工具</strong><br/>
  通过截图、拍照小票、语音、剪贴板、快捷指令和酒店水单 PDF，把消费信息整理为可复核的个人账本。
</p>
...
- **本地邮箱扫描**：用户主动在 App 内连接 IMAP 邮箱，授权码只保存在本机 Keychain；App 拉取带 PDF 附件的候选邮件，用户勾选后批量导入。
