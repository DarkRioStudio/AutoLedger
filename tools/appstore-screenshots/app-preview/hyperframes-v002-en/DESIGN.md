# AutoLedger App Preview v002 English Design

## Style Prompt

Create a clean, warm, Apple-ecosystem product preview for AutoLedger ASC 1.5.0. The video should feel like a practical App Store demo rather than a brand film: real UI screenshots, calm motion, precise highlights, and short English copy. The narrative should include current hotel spending and AutoLedger Pro automation capabilities while still making the free quick-ledger flow clear.
...
- Overall pace: 22 seconds, medium energy.
